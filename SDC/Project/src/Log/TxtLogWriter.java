...
public class TxtLogWriter implements LogWriter{
    ...
    private static final String logFilePath = Paths.get(System.getProperty("user.home"), "Desktop", "log.txt").toString();
     ...
     */
    @Override
    public void Write(String type, String module, String logMessage) {
